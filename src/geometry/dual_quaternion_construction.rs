...
// use geometry::{DualQuaternion, Rotation, UnitDualQuaternion};
...
//     /// # Example
//     /// ```
//     /// # use nalgebra::{DualQuaternion, Vector3, Vector4};
//     /// let w = 1.0;
//     /// let ijk = Vector3::new(2.0, 3.0, 4.0);
//     /// let q = DualQuaternion::from_parts(w, ijk);
//     /// assert!(q.i == 2.0 && q.j == 3.0 && q.k == 4.0 && q.w == 1.0);
//     /// assert_eq!(*q.as_vector(), Vector4::new(2.0, 3.0, 4.0, 1.0));
//     /// ```
//     #[inline]
...
//     where SB: Storage<N, U3> {
//         let rot = UnitDualQuaternion::<N>::from_axis_angle(&axis, theta * ::convert(2.0f64));
...
//     /// let q = DualQuaternion::identity();
//     /// let q2 = DualQuaternion::new(1.0, 2.0, 3.0, 4.0);
//     ///
//     /// assert_eq!(q * q2, q2);
//     /// assert_eq!(q2 * q, q2);
//     /// ```
...
//         DualQuaternion::new(rng.gen(), rng.gen(), rng.gen(), rng.gen())
//     }
// }

// #[cfg(feature = "arbitrary")]
// impl<N: Real + Arbitrary> Arbitrary for DualQuaternion<N>
...
//     /// # Example
//     /// ```
//     /// # use nalgebra::{UnitDualQuaternion, Vector3, Point3};
//     /// let q = UnitDualQuaternion::identity();
//     /// let q2 = UnitDualQuaternion::new(Vector3::new(1.0, 2.0, 3.0));
...
//     /// # use std::f32;
//     /// # use nalgebra::{UnitDualQuaternion, Point3, Vector3};
//     /// let axis = Vector3::y_axis();
//     /// let angle = f32::consts::FRAC_PI_2;
//     /// // Point and vector being transformed in the tests.
//     /// let pt = Point3::new(4.0, 5.0, 6.0);
//     /// let vec = Vector3::new(4.0, 5.0, 6.0);
//     /// let q = UnitDualQuaternion::from_axis_angle(&axis, angle);
//     ///
...
//     /// assert_eq!(UnitDualQuaternion::from_scaled_axis(Vector3::<f32>::zeros()), UnitDualQuaternion::identity());
//     /// ```
//     #[inline]
...
//         let q = DualQuaternion::from_parts(cang, axis.as_ref() * sang);
...
//     #[inline]
//     pub fn from_quaternion(q: DualQuaternion<N>) -> Self {
...
//     /// ```
//     /// # #[macro_use] extern crate approx;
//     /// # use nalgebra::{Rotation3, UnitDualQuaternion, Vector3};
//     /// let axis = Vector3::y_axis();
//     /// let angle = 0.1;
//     /// let rot = Rotation3::from_axis_angle(&axis, angle);
//     /// let q = UnitDualQuaternion::from_rotation_matrix(&rot);
...
//     /// let q = UnitDualQuaternion::rotation_between(&a, &b).unwrap();
...
//     /// let a = Vector3::new(1.0, 2.0, 3.0);
//     /// let b = Vector3::new(3.0, 1.0, 2.0);
//     /// let q2 = UnitDualQuaternion::scaled_rotation_between(&a, &b, 0.2).unwrap();
//     /// let q5 = UnitDualQuaternion::scaled_rotation_between(&a, &b, 0.5).unwrap();
...
//     /// ```
//     /// # #[macro_use] extern crate approx;
//     /// # use nalgebra::{Unit, Vector3, UnitDualQuaternion};
...
//     /// let up = Vector3::y();
//     ///
//     /// let q = UnitDualQuaternion::face_towards(&dir, &up);
...
//     /// Deprecated: Use [UnitDualQuaternion::face_towards] instead.
...
//     /// let up = Vector3::y();
//     ///
//     /// let q = UnitDualQuaternion::look_at_rh(&dir, &up);
...
//     /// let up = Vector3::y();
//     ///
//     /// let q = UnitDualQuaternion::look_at_lh(&dir, &up);
//     /// assert_relative_eq!(q * dir.normalize(), Vector3::z());
//     /// ```
//     #[inline]
...
//     ///
//     /// // A zero vector yields an identity.
//     /// assert_eq!(UnitDualQuaternion::new(Vector3::<f32>::zeros()), UnitDualQuaternion::identity());
//     /// ```
//     #[inline]
//     pub fn new<SB>(axisangle: Vector<N, U3, SB>) -> Self
//     where SB: Storage<N, U3> {
//         let two: N = ::convert(2.0f64);
//         let q = DualQuaternion::<N>::from_parts(N::zero(), axisangle / two).exp();
//         Self::new_unchecked(q)
//     }
...
//     /// let pt = Point3::new(4.0, 5.0, 6.0);
//     /// let vec = Vector3::new(4.0, 5.0, 6.0);
//     /// let q = UnitDualQuaternion::new_eps(axisangle, 1.0e-6);
//     ///
//     /// assert_relative_eq!(q * pt, Point3::new(6.0, 5.0, -4.0), epsilon = 1.0e-6);
//     /// assert_relative_eq!(q * vec, Vector3::new(6.0, 5.0, -4.0), epsilon = 1.0e-6);
//     ///
//     /// // An almost zero vector yields an identity.
//     /// assert_eq!(UnitDualQuaternion::new_eps(Vector3::new(1.0e-8, 1.0e-9, 1.0e-7), 1.0e-6), UnitDualQuaternion::identity());
//     /// ```
//     #[inline]
//     pub fn new_eps<SB>(axisangle: Vector<N, U3, SB>, eps: N) -> Self
//     where SB: Storage<N, U3> {
//         let two: N = ::convert(2.0f64);
//         let q = DualQuaternion::<N>::from_parts(N::zero(), axisangle / two).exp_eps(eps);
//         Self::new_unchecked(q)
//     }
...
//     /// let pt = Point3::new(4.0, 5.0, 6.0);
//     /// let vec = Vector3::new(4.0, 5.0, 6.0);
//     /// let q = UnitDualQuaternion::from_scaled_axis(axisangle);
//     ///
//     /// assert_relative_eq!(q * pt, Point3::new(6.0, 5.0, -4.0), epsilon = 1.0e-6);
//     /// assert_relative_eq!(q * vec, Vector3::new(6.0, 5.0, -4.0), epsilon = 1.0e-6);
//     ///
...
//     /// let pt = Point3::new(4.0, 5.0, 6.0);
//     /// let vec = Vector3::new(4.0, 5.0, 6.0);
//     /// let q = UnitDualQuaternion::from_scaled_axis_eps(axisangle, 1.0e-6);
//     ///
//     /// assert_relative_eq!(q * pt, Point3::new(6.0, 5.0, -4.0), epsilon = 1.0e-6);
//     /// assert_relative_eq!(q * vec, Vector3::new(6.0, 5.0, -4.0), epsilon = 1.0e-6);
//     ///
//     /// // An almost zero vector yields an identity.
//     /// assert_eq!(UnitDualQuaternion::from_scaled_axis_eps(Vector3::new(1.0e-8, 1.0e-9, 1.0e-7), 1.0e-6), UnitDualQuaternion::identity());
//     /// ```
//     #[inline]
...
// impl<N: Real> One for UnitDualQuaternion<N> {
//     #[inline]
//     fn one() -> Self {
//         Self::identity()
//     }
...
// impl<N: Real> Distribution<UnitDualQuaternion<N>> for Standard
// where OpenClosed01: Distribution<N>
// {
//     /// Generate a uniformly distributed random rotation quaternion.
//     #[inline]
//     fn sample<'a, R: Rng + ?Sized>(&self, rng: &'a mut R) -> UnitDualQuaternion<N> {
...
//         let r2 = x0.sqrt();
//         Unit::new_unchecked(DualQuaternion::new(s1 * r1, c1 * r1, s2 * r2, c2 * r2))
//     }
// }

// #[cfg(feature = "arbitrary")]
// impl<N: Real + Arbitrary> Arbitrary for UnitDualQuaternion<N>
// where
//     Owned<N, U4>: Send,
//     Owned<N, U3>: Send,
// {
...
//         UnitDualQuaternion::from_scaled_axis(axisangle)
//     }
// }
...
//         for _ in 0..1000 {
//             let x = rng.gen::<UnitDualQuaternion<f32>>();
