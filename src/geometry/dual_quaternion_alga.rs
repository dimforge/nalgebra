...
// use geometry::{Point3, DualQuaternion, UnitDualQuaternion};

// impl<N: Real> Identity<Multiplicative> for DualQuaternion<N> {
//     #[inline]
//     fn identity() -> Self {
//         Self::identity()
//     }
...
// impl<N: Real> Identity<Additive> for DualQuaternion<N> {
//     #[inline]
//     fn identity() -> Self {
//         Self::zero()
//     }
...
// impl<N: Real> AbstractMagma<Multiplicative> for DualQuaternion<N> {
//     #[inline]
...
// impl<N: Real> AbstractMagma<Additive> for DualQuaternion<N> {
//     #[inline]
//     fn operate(&self, rhs: &Self) -> Self {
//         self + rhs
//     }
...
// impl<N: Real> TwoSidedInverse<Additive> for DualQuaternion<N> {
//     #[inline]
...
//         impl<N: Real> $marker<$operator> for $DualQuaternion<N> { }
//     )*}
// );
...
//  *
//  */
// impl<N: Real> AbstractModule for DualQuaternion<N> {
//     type AbstractRing = N;
...
// impl<N: Real> Module for DualQuaternion<N> {
//     type Ring = N;
// }

// impl<N: Real> VectorSpace for DualQuaternion<N> {
//     type Field = N;
// }

// impl<N: Real> FiniteDimVectorSpace for DualQuaternion<N> {
//     #[inline]
//     fn dimension() -> usize {
//         4
//     }
...
// impl<N: Real> NormedSpace for DualQuaternion<N> {
//     #[inline]
...
//  *
//  */
// impl<N: Real> Identity<Multiplicative> for UnitDualQuaternion<N> {
//     #[inline]
//     fn identity() -> Self {
//         Self::identity()
//     }
...
// impl<N: Real> AbstractMagma<Multiplicative> for UnitDualQuaternion<N> {
//     #[inline]
//     fn operate(&self, rhs: &Self) -> Self {
//         self * rhs
//     }
...
// impl<N: Real> TwoSidedInverse<Multiplicative> for UnitDualQuaternion<N> {
//     #[inline]
//     fn two_sided_inverse(&self) -> Self {
//         self.inverse()
//     }
...
// impl<N: Real> Transformation<Point3<N>> for UnitDualQuaternion<N> {
//     #[inline]
...
// impl<N: Real> ProjectiveTransformation<Point3<N>> for UnitDualQuaternion<N> {
//     #[inline]
...
// impl<N: Real> AffineTransformation<Point3<N>> for UnitDualQuaternion<N> {
//     type Rotation = Self;
...
// impl<N: Real> Similarity<Point3<N>> for UnitDualQuaternion<N> {
//     type Scaling = Id;
...
//     ($($Trait: ident),*) => {$(
//         impl<N: Real> $Trait<Point3<N>> for UnitDualQuaternion<N> { }
//     )*}
// );

// marker_impl!(Isometry, DirectIsometry, OrthogonalTransformation);

// impl<N: Real> Rotation<Point3<N>> for UnitDualQuaternion<N> {
//     #[inline]
