...
/// The LDL / LDL^T factorization of a Hermitian matrix A = LDL^T where L is a
/// lower unit-triangular matrix and D is diagonal matrix.
    ...
    DefaultAllocator: Allocator<D> + Allocator<D, D>,
{
    ...
    pub l: OMatrix<T, D, D>,
    /// The diagonal matrix, in vector form, resulting from the factorization
    pub d: OVector<T, D>,
}
    ...
    DefaultAllocator: Allocator<D> + Allocator<D, D>,
{
    ...
    ///
    /// This function can be used to generate a lower triangular matrix as if it were
    /// generated by the Cholesky decomposition without the requirement of positive definiteness.
    ///
