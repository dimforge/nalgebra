...
#[deprecated = deprecation_note!(SMatrixView)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(DMatrixView)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView1)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView2)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView3)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView4)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView5)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView1x2)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView1x3)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView1x4)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView1x5)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView1x6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView2x1)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView2x3)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView2x4)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView2x5)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView2x6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView3x1)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView3x2)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView3x4)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView3x5)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView3x6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView4x1)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView4x2)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView4x3)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView4x5)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView4x6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView5x1)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView5x2)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView5x3)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView5x4)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView5x6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView6x1)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView6x2)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView6x3)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView6x4)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(MatrixView6x5)]
...
#[deprecated = deprecation_note!(MatrixView1xX)]
...
#[deprecated = deprecation_note!(MatrixView2xX)]
...
#[deprecated = deprecation_note!(MatrixView3xX)]
...
#[deprecated = deprecation_note!(MatrixView4xX)]
...
#[deprecated = deprecation_note!(MatrixView5xX)]
...
#[deprecated = deprecation_note!(MatrixView6xX)]
...
#[deprecated = deprecation_note!(MatrixViewXx1)]
...
#[deprecated = deprecation_note!(MatrixViewXx2)]
...
#[deprecated = deprecation_note!(MatrixViewXx3)]
...
#[deprecated = deprecation_note!(MatrixViewXx4)]
...
#[deprecated = deprecation_note!(MatrixViewXx5)]
...
#[deprecated = deprecation_note!(MatrixViewXx6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorView)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(SVectorView)]
...
#[deprecated = deprecation_note!(DVectorView)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(SMatrixViewMut)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(DMatrixViewMut)]
...
/// A column-major matrix slice with a number of rows chosen at runtime and 2 columns.
#[deprecated = deprecation_note!(MatrixViewMutXx2)]
...
/// A column-major matrix slice with a number of rows chosen at runtime and 3 columns.
#[deprecated = deprecation_note!(MatrixViewMutXx3)]
...
/// A column-major matrix slice with a number of rows chosen at runtime and 4 columns.
#[deprecated = deprecation_note!(MatrixViewMutXx4)]
...
/// A column-major matrix slice with a number of rows chosen at runtime and 5 columns.
#[deprecated = deprecation_note!(MatrixViewMutXx5)]
...
/// A column-major matrix slice with a number of rows chosen at runtime and 6 columns.
#[deprecated = deprecation_note!(MatrixViewMutXx6)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(SVectorViewMut)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(DVectorViewMut)]
...
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut1)]
pub type VectorSliceMut1<'a, T, RStride = U1, CStride = U1> =
    Matrix<T, U1, U1, ViewStorageMut<'a, T, U1, U1, RStride, CStride>>;
/// A 2D column vector slice.
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut2)]
pub type VectorSliceMut2<'a, T, RStride = U1, CStride = U2> =
    Matrix<T, U2, U1, ViewStorageMut<'a, T, U2, U1, RStride, CStride>>;
/// A 3D column vector slice.
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut3)]
pub type VectorSliceMut3<'a, T, RStride = U1, CStride = U3> =
    Matrix<T, U3, U1, ViewStorageMut<'a, T, U3, U1, RStride, CStride>>;
/// A 4D column vector slice.
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut4)]
pub type VectorSliceMut4<'a, T, RStride = U1, CStride = U4> =
    Matrix<T, U4, U1, ViewStorageMut<'a, T, U4, U1, RStride, CStride>>;
/// A 5D column vector slice.
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut5)]
pub type VectorSliceMut5<'a, T, RStride = U1, CStride = U5> =
    Matrix<T, U5, U1, ViewStorageMut<'a, T, U5, U1, RStride, CStride>>;
/// A 6D column vector slice.
///
/// **Because this is an alias, not all its methods are listed here. See the [`Matrix`](crate::base::Matrix) type too.**
#[deprecated = deprecation_note!(VectorViewMut6)]
